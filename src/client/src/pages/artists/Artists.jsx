                ...
                {artistList.length === 0 ? (
                    ...
                    <>
                        ...
                        <Link to="/artists/new" className="btn btn-primary">
                            <span>Add Artist</span> <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#FFFFFF"><path d="M444-444H240v-72h204v-204h72v204h204v72H516v204h-72v-204Z" /></svg>
                        </Link>
                    </>
                )}
