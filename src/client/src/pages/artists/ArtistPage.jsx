...
export default function ArtistPage() {
    ...
    return (
        <>
            {artist ? (
                <>
                    <header id="artist_page_header" style={{ backgroundImage: `url(${artist.imageUrl || "/placeholder-artist.png"})` }}>
                        <div className="container">
                            <div id="artist_header_panel" className="panel text-center" style={{ backgroundImage: `url(${artist.imageUrl || "/placeholder-artist.png"})` }}>
